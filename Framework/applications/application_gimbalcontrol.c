...
PID_Regulator_t yawSpeedPID = PID_INIT(30.0, 0.0, 1.0, 10000.0, 10000.0, 10000.0, 4900.0);

PID_Regulator_t pitchPositionPID = PID_INIT(8.0, 0.00, 0.5, 10000.0, 10000.0, 10000.0, 10000.0);
PID_Regulator_t pitchSpeedPID = PID_INIT(30.0, 0.0, 1.0, 10000.0, 10000.0, 10000.0, 4900.0);
